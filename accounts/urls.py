...
from .views import BankAccountListView, BankAccountCreateView, BankAccountDetailView, TransferMoneyView,TransactionSearchView
...
urlpatterns = [
    ...
    path('<int:pk>', BankAccountDetailView.as_view(), name='bankaccount-detail'),   # GET, PUT, DELETE an account
